...
### ac58_joint_publisher, excavator_com3_ros, g2_publisher, gnss_poserは自動起動
### hitachi_ros または hitachi_rc_driver は手動で起動
def generate_launch_description():
    ...
    zx120_bringup_dir_path=get_package_share_directory("zx120_bringup")
    map_base_broadcaster_dir_path=get_package_share_directory("map_base_broadcaster")
    odom_publisher_dir_path=get_package_share_directory("odom_publisher")
    ...
    # localization
    map_base_broadcast_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(map_base_broadcaster_dir_path, "launch/map_base_broadcast.launch.py")),
    )
    odom_publisher_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(odom_publisher_dir_path, "launch/odom_publisher.launch.py")),
    )
    ekf_localization_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(zx120_bringup_dir_path, "launch/ekf_localization.launch.py")),
    )
    ###
    ...
    ld.add_action(map_base_broadcast_launch)
    ld.add_action(odom_publisher_launch)
